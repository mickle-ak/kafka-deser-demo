...
public class ErrorHandlerConfig {
     ...
     */
    @Bean(name = "pipelineProcessingConsumerErrorHandler")
     ...
     */
    @Bean(name = "pipelineProcessingRetryStrategy")
     ...
     */
    @Bean(name = "pipelineProcessingConsumerRecordRecoverer")
     ...
     */
    @Bean(name = "pipelineProcessingRetryListener")
